...
public class FastPointOverlay extends Overlay {
    ...
    public FastPointOverlay(PointAdapter pointList, FastPointOverlayOptions style) {
        mStyle = style;
    ...
    public FastPointOverlay(PointAdapter pointList) {
...
//                pj.toPixels(pt1, mPositionPixels);
    ...
    public boolean onTouchEvent(MotionEvent event, final MapView mapView) {
        if(mStyle.mAlgorithm !=
                FastPointOverlayOptions.RenderingAlgorithm.MAXIMUM_OPTIMIZATION) return false;
        ...
        if(mStyle.mPointStyle != null || mPointList.isStyled()) {
            switch (mStyle.mAlgorithm) {
                case MAXIMUM_OPTIMIZATION:
                    ...
                    showLabels =
                            ((mStyle.mLabelPolicy == FastPointOverlayOptions.LabelPolicy.DENSITY_THRESHOLD
                                    && numLabels <= mStyle.mMaxNShownLabels)
                                    || (mStyle.mLabelPolicy == FastPointOverlayOptions.LabelPolicy.ZOOM_THRESHOLD
                ...
                case MEDIUM_OPTIMIZATION:
                    ...
                    showLabels = (mStyle.mLabelPolicy == FastPointOverlayOptions.LabelPolicy.ZOOM_THRESHOLD
                            && mapView.getZoomLevelDouble() >= mStyle.mMinZoomShowLabels);
