...
public class Repository {
    ...
    public Observable<List<SimplePolygon>> getCustomPolygon(Context context, double tolerance) {
...
//                    FolderOverlay folderOverlay = new FolderOverlay();
    ...
    private Observable<List<SimplePolygon>> getGeoJsonFromString(Context context, String geoJsonStr, double tolerance) {
        Observable<List<SimplePolygon>> main = Observable.fromCallable(() -> geoJsonStr)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .doOnNext(s -> Toast.makeText(context, "GeoJson loading", Toast.LENGTH_SHORT).show())
                .observeOn(Schedulers.computation())
