...
public class FastPointOverlayOptions {
    ...
    public FastPointOverlayOptions() {
    ...
    /**
     * Creates a new {@link FastPointOverlayOptions} object with default options.
     * @return {@link FastPointOverlayOptions}
     */
    public static FastPointOverlayOptions getDefaultStyle() {
        return new FastPointOverlayOptions();
    }
     ...
     * @return The updated {@link FastPointOverlayOptions}
     */
    public FastPointOverlayOptions setPointStyle(Paint style) {
        mPointStyle = style;
        return this;
    }
     ...
     * @return The updated {@link FastPointOverlayOptions}
     */
    public FastPointOverlayOptions setSelectedPointStyle(Paint style) {
     ...
     * @return The updated {@link FastPointOverlayOptions}
     */
    public FastPointOverlayOptions setRadius(float radius) {
     ...
     * @return The updated {@link FastPointOverlayOptions}
     */
    public FastPointOverlayOptions setSelectedRadius(float radius) {
     ...
     * @return The updated {@link FastPointOverlayOptions}
     */
    public FastPointOverlayOptions setIsClickable(boolean clickable) {
     ...
     * @return The updated {@link FastPointOverlayOptions}
     */
    public FastPointOverlayOptions setCellSize(int cellSize) {
        mCellSize = cellSize;
        return this;
    }
     ...
     * @return The updated {@link FastPointOverlayOptions}
     */
    public FastPointOverlayOptions setAlgorithm(RenderingAlgorithm algorithm) {
     ...
     * @return The updated {@link FastPointOverlayOptions}
     */
    public FastPointOverlayOptions setSymbol(Shape symbol) {
        mSymbol = symbol;
        return this;
    }
     ...
     * @return The updated {@link FastPointOverlayOptions}
     */
    public FastPointOverlayOptions setTextStyle(Paint textStyle) {
     ...
     * @return
     */
    public FastPointOverlayOptions setMinZoomShowLabels(int minZoomShowLabels) {
     ...
     * @return
     */
    public FastPointOverlayOptions setMaxNShownLabels(int maxNShownLabels) {
     ...
     * @return
     */
    public FastPointOverlayOptions setLabelPolicy(LabelPolicy labelPolicy) {
