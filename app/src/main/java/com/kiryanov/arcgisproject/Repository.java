...
public class Repository {
    ...
    public Observable<List<Polygon>> getCustomPolygon(Context context) {
        ...
        return getGeoJsonFromString(context, geoJson);
    }

    private Observable<List<Polygon>> getGeoJson(Context context, String url) {
    ...
    private Observable<List<Polygon>> getGeoJsonFromString(Context context, String geoJsonStr) {
